...
@endphp
            ...
            <a href="{{ url('/chart/search') }}" class="mb-0 text-uppercase btn btn-warning btn-sm"><i class="bi bi-bar-chart-steps" style="color:white"></i></a>

            <a href="{{ url('/ac/export') }}" style="background: #1F6E43"  class="mb-0 text-uppercase btn btn-secondary btn-sm"><i class="bi bi-file-spreadsheet"></i></a>
                  ...
                  <tr id="sid{{ $ac->id }}" style="text-transform: capitalize">
                    ...
                    <td>
                        <div class="table-actions d-flex align-items-center gap-3 fs-6">
                            ...
                            <a href="{{ url('/ac/update/' . $ac->id) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i>
                            </a>

                            @can('admin')
                            <a id="btnDeleteAc" href="{{ url('/ac/delete/' . $ac->id) }}" class="text-danger btn-delete" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-x-circle-fill"></i></a>
                            @endcan
                          </div>
                    </td>
                  </tr>
